...
function morgan_mounted1(){
	...
	if ($('#c1_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.003ra.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_1" id="menu_c1_1" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.003ra.jpg" onclick = "swap_picture(c1_1, menu_c1_1,text_c1_1, morgan_c1_1)">Selected Version: Morgan</option> \
		...
		$(\'#note_c1_1\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c1_1\",$(\'#note_c1_1\').val());\
			$(\'#note_c1_1\').val(localStorage.getItem(\"morgan_mounted_c1_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.003rb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_2" id="menu_c1_2" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.003rb.jpg" onclick = "swap_picture(c1_2, menu_c1_2,text_c1_2, morgan_c1_2)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_41r2.jpg" onclick = "swap_picture(c1_2, menu_c1_2,text_c1_2, getty_c1_2)">Selected Version: Getty</option> \
		...
		$(\'#note_c1_2\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c1_2\",$(\'#note_c1_2\').val());\
			$(\'#note_c1_2\').val(localStorage.getItem(\"morgan_mounted_c1_2\"));\
		});\
		</script><br>';
...
function morgan_mounted2(){
	...
	if ($('#c2_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.003va.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_1" id="menu_c2_1" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.003va.jpg" onclick = "swap_picture(c2_1, menu_c2_1,text_c2_1, morgan_c2_1)">Selected Version: Morgan</option> \
		...
		$(\'#note_c2_1\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c2_1\",$(\'#note_c2_1\').val());\
			$(\'#note_c2_1\').val(localStorage.getItem(\"morgan_mounted_c2_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.003vb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_2" id="menu_c2_2" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.003vb.jpg" onclick = "swap_picture(c2_2, menu_c2_2,text_c2_2, morgan_c2_2)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_41v2.jpg" onclick = "swap_picture(c2_2, menu_c2_2,text_c2_2, getty_c2_2)">Selected Version: Getty</option> \
		...
		$(\'#note_c2_2\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c2_2\",$(\'#note_c2_2\').val());\
			$(\'#note_c2_2\').val(localStorage.getItem(\"morgan_mounted_c2_2\"));\
		});\
		</script><br>';
...
function morgan_mounted3(){
	...
	if ($('#c3_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.004ra.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c3_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c3_1" id="menu_c3_1" data-mini="true" stlye = "padding-left: 15%;"> \
				<option  selected="selected" value="img/morgan-images/m383.004ra.jpg" onclick = "swap_picture(c3_1, menu_c3_1,text_c3_1, morgan_c3_1)">Selected Version: Morgan</option> \
		...
		$(\'#note_c3_1\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c3_1\",$(\'#note_c3_1\').val());\
			$(\'#note_c3_1\').val(localStorage.getItem(\"morgan_mounted_c3_1\"));\
		});\
		</script><br>';
...
function morgan_mounted4(){
	...
	if ($('#c4_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.004rb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_1" id="menu_c4_1" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected"  value="img/morgan-images/m383.004rb.jpg" onclick = "swap_picture(c4_1, menu_c4_1,text_c4_1, morgan_c4_1)">Selected Version: Morgan</option> \
		...
		$(\'#note_c4_1\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c4_1\",$(\'#note_c4_1\').val());\
			$(\'#note_c4_1\').val(localStorage.getItem(\"morgan_mounted_c4_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.004va.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_2" id="menu_c4_2" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.004va.jpg" onclick = "swap_picture(c4_2, menu_c4_2,text_c4_2, morgan_c4_2)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_42v1.jpg" onclick = "swap_picture(c4_2, menu_c4_2,text_c4_2, getty_c4_2)">Selected Version: Getty</option> \
		...
		$(\'#note_c4_2\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c4_2\",$(\'#note_c4_2\').val());\
			$(\'#note_c4_2\').val(localStorage.getItem(\"morgan_mounted_c4_2\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.004vb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_3" id="menu_c4_3" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.004vb.jpg" onclick = "swap_picture(c4_3, menu_c4_3,text_c4_3, morgan_c4_3)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_42v2.jpg" onclick = "swap_picture(c4_3, menu_c4_3,text_c4_3, getty_c4_3)">Selected Version: Getty</option> \
		...
		$(\'#note_c4_3\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c4_3\",$(\'#note_c4_3\').val());\
			$(\'#note_c4_3\').val(localStorage.getItem(\"morgan_mounted_c4_3\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.005r1.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_4" id="menu_c4_4" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.005r1.jpg" onclick = "swap_picture(c4_4, menu_c4_4,text_c4_4, morgan_c4_4)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_43r1.jpg" onclick = "swap_picture(c4_4, menu_c4_4,text_c4_4, getty_c4_4)">Selected Version: Getty</option> \
		...
		$(\'#note_c4_4\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c4_4\",$(\'#note_c4_4\').val());\
			$(\'#note_c4_4\').val(localStorage.getItem(\"morgan_mounted_c4_4\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.005r2.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_5"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_5" id="menu_c4_5" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.005r2.jpg" onclick = "swap_picture(c4_5, menu_c4_5,text_c4_5, morgan_c4_5)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_43r2.jpg" onclick = "swap_picture(c4_5, menu_c4_5,text_c4_5, getty_c4_5)">Selected Version: Getty</option> \
		...
		$(\'#note_c4_5\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c4_5\",$(\'#note_c4_5\').val());\
			$(\'#note_c4_5\').val(localStorage.getItem(\"morgan_mounted_c4_5\"));\
		});\
		</script><br>';
...
function morgan_mounted5(){
	...
	if ($('#c5_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.005va.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_1" id="menu_c5_1" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.005va.jpg" onclick = "swap_picture(c5_1, menu_c5_1,text_c5_1, morgan_c5_1)">Selected Version: Morgan</option> \
		...
		$(\'#note_c5_1\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c5_1\",$(\'#note_c5_1\').val());\
			$(\'#note_c5_1\').val(localStorage.getItem(\"morgan_mounted_c5_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.005vb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_2" id="menu_c5_2" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.005vb.jpg" onclick = "swap_picture(c5_2, menu_c5_2,text_c5_2, morgan_c5_2)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_43v2.jpg" onclick = "swap_picture(c5_2, menu_c5_2,text_c5_2, getty_c5_2)">Selected Version: Getty</option> \
		...
		$(\'#note_c5_2\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c5_2\",$(\'#note_c5_2\').val());\
			$(\'#note_c5_2\').val(localStorage.getItem(\"morgan_mounted_c5_2\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.006rb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_3" id="menu_c5_3" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected"  value="img/morgan-images/m383.006rb.jpg" onclick = "swap_picture(c5_3, menu_c5_3,text_c5_3, morgan_c5_3)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_44r1.jpg" onclick = "swap_picture(c5_3, menu_c5_3,text_c5_3, getty_c5_3)">Selected Version: Getty</option> \
		...
		$(\'#note_c5_3\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c5_3\",$(\'#note_c5_3\').val());\
			$(\'#note_c5_3\').val(localStorage.getItem(\"morgan_mounted_c5_3\"));\
		});\
		</script><br>';
		menu_c5_3 = menu_c5_3 + c5_3_note;
		
		//image file Crossings of the Sword
		var c5_4= '\
		<h2 style = "padding-left: 5%">Crossings of the Sword</h2>\
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.006ra.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_4"> \
		</div>';

		//image text Crossings of the Sword
		var getty_text = '<div id = getty_c5_4 style="display: none;">\
		</div>';
		var morgan_text = '<div id = morgan_c5_4 style="display: none;">\
		These two Masters are here crossed at the full of the sword. And that which one can do, the other can do also—that is, \
		he can do all the plays of the sword with this crossing. But crossing is of three categories (that is, from the full of \
		the sword to the tip of the sword), and whoever is crossed at the full of the sword can withstand a little, and whoever \
		is crossed at middle of the sword can withstand less, and whoever at the tip of the sword can withstand nothing at all. \
		So the sword, as such, has three matters—that is, a little, less, and nothing. \
		</div>';
		var pd_text =' <div id = pd_text_c5_4 style="display: none;">\
		This is an equal crossing, without advantage. \
		Whoever has more art and malice begins the action.\
		</div>';
		var florius_text ='<div id = florius_text_c5_4 style="display: none;">\
		</div>';
		
		//image swap menu Crossings of the Sword
		var menu_c5_4 = '\
		<form style="width:80%; text-align:center; padding-left: 20%;"> \
		<div class="ui-field-contain" > \
			<label for="menu_c5_4"></label><br> \
			<select name = "menu_c5_4" id="menu_c5_4" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected"  value="img/morgan-images/m383.006ra.jpg" onclick = "swap_picture(c5_4, menu_c5_4,text_c5_4, morgan_c5_4)">Selected Version: Morgan</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_32a2.jpg" onclick = "swap_picture(c5_4, menu_c5_4,text_c5_4, pd_text_c5_4)">Selected Version: Pisani-Dossi</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		//Note section Crossings of the Sword
		...
		$(\'#note_c5_4\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c5_4\",$(\'#note_c5_4\').val());\
			$(\'#note_c5_4\').val(localStorage.getItem(\"morgan_mounted_c5_4\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.006rc.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_5"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_5" id="menu_c5_5" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected"  value="img/morgan-images/m383.006rc.jpg" onclick = "swap_picture(c5_5, menu_c5_5,text_c5_5, morgan_c5_5)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_44r2.jpg" onclick = "swap_picture(c5_5, menu_c5_5,text_c5_5, getty_c5_5)">Selected Version: Getty</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_32a3.jpg" onclick = "swap_picture(c5_5, menu_c5_5,text_c5_5, pd_text_c5_5)">Selected Version: Pisani-Dossi</option> \
				<option value="img/florius-images/f10.highresb.jpg" onclick = "swap_picture(c5_5, menu_c5_5,text_c5_5, florius_text_c5_5)">Selected Version: Florius</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c5_5\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c5_5\",$(\'#note_c5_5\').val());\
			$(\'#note_c5_5\').val(localStorage.getItem(\"morgan_mounted_c5_5\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.006rd.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_6"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_6" id="menu_c5_6" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected"  value="img/morgan-images/m383.006rd.jpg" onclick = "swap_picture(c5_6, menu_c5_6,text_c5_6, morgan_c5_6)">Selected Version: Morgan</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_32a4.jpg" onclick = "swap_picture(c5_6, menu_c5_6,text_c5_6, pd_text_c5_6)">Selected Version: Pisani-Dossi</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_44r3.jpg" onclick = "swap_picture(c5_6, menu_c5_6,text_c5_6, getty_c5_6)">Selected Version: Getty</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c5_6\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c5_6\",$(\'#note_c5_6\').val());\
			$(\'#note_c5_6\').val(localStorage.getItem(\"morgan_mounted_c5_6\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.006va.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_7"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_7" id="menu_c5_7" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.006va.jpg" onclick = "swap_picture(c5_7, menu_c5_7,text_c5_7, morgan_c5_7)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_44r4.jpg" onclick = "swap_picture(c5_7, menu_c5_7,text_c5_7, getty_c5_7)">Selected Version: Getty</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_32b1.jpg" onclick = "swap_picture(c5_7, menu_c5_7,text_c5_7, pd_text_c5_7)">Selected Version: Pisani-Dossi</option> \
				<option value="img/florius-images/f11.highresa.jpg" onclick = "swap_picture(c5_7, menu_c5_7,text_c5_7, florius_text_c5_7)">Selected Version: Florius</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c5_7\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c5_7\",$(\'#note_c5_7\').val());\
			$(\'#note_c5_7\').val(localStorage.getItem(\"morgan_mounted_c5_7\"));\
		});\
		</script><br>';
...
function morgan_mounted6(){
	...
	if ($('#c6_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.006vb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c6_1"> \
		</div>';

		//image text play 6
		var getty_text = '<div id = getty_c6_1 style="display: none;">\
		This is the sixth play (5th in Pisani-Dossi), where you take away your opponent\’s sword. You use the hilt of your sword to lift his hilt upwards, which will make his \
		sword fall from his hands. \
		</div>';
		var morgan_text = '<div id = morgan_c6_1 style="display: none;">\
		This is the sixth play (5th in Pisani-Dossi) that makes a cover with the beating of the sword. I throw my arm to his neck and quickly turn, and I will throw you to the \
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c6_1" id="menu_c6_1" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.006vb.jpg" onclick = "swap_picture(c6_1, menu_c6_1,text_c6_1, morgan_c6_1)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_44v2.jpg" onclick = "swap_picture(c6_1, menu_c6_1,text_c6_1, getty_c6_1)">Selected Version: Getty</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_32b2.jpg" onclick = "swap_picture(c6_1, menu_c6_1,text_c6_1, pd_text_c6_1)">Selected Version: Pisani-Dossi</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c6_1\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c6_1\",$(\'#note_c6_1\').val());\
			$(\'#note_c6_1\').val(localStorage.getItem(\"morgan_mounted_c6_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.006vc.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c6_2"> \
		</div>';

		//image text play 5
		var getty_text = '<div id = getty_c6_2 style="display: none;">\
		This is the fifth play (6th in Pisani-Dossi) that flows from the cover where you beat aside his sword. Here I throw my arm around his neck and turn quickly, and with the \
		...
		This is the fifth play (6th in Pisani-Dossi), in which he wants to take the sword of his companion with the hilt of his sword; the other hilt he will have above, and the sword \
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c6_2" id="menu_c6_2" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.006vc.jpg" onclick = "swap_picture(c6_2, menu_c6_2,text_c6_2, morgan_c6_2)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_44v1.jpg" onclick = "swap_picture(c6_2, menu_c6_2,text_c6_2, getty_c6_2)">Selected Version: Getty</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_32b3.jpg" onclick = "swap_picture(c6_2, menu_c6_2,text_c6_2, pd_text_c6_2)">Selected Version: Pisani-Dossi</option> \
				<option value="img/florius-images/f11.highresb.jpg" onclick = "swap_picture(c6_2, menu_c6_2,text_c6_2, florius_text_c6_2)">Selected Version: Florius</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c6_2\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c6_2\",$(\'#note_c6_2\').val());\
			$(\'#note_c6_2\').val(localStorage.getItem(\"morgan_mounted_c6_2\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.006vd.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c6_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c6_3" id="menu_c6_3" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.006vd.jpg" onclick = "swap_picture(c6_3, menu_c6_3,text_c6_3, morgan_c6_3)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_44v3.jpg" onclick = "swap_picture(c6_3, menu_c6_3,text_c6_3, getty_c6_3)">Selected Version: Getty</option> \
		...
		$(\'#note_c6_3\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c6_3\",$(\'#note_c6_3\').val());\
			$(\'#note_c6_3\').val(localStorage.getItem(\"morgan_mounted_c6_3\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.007ra.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c6_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c6_4" id="menu_c6_4" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected"  value="img/morgan-images/m383.007ra.jpg" onclick = "swap_picture(c6_4, menu_c6_4,text_c6_4, morgan_c6_4)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_44v4.jpg" onclick = "swap_picture(c6_4, menu_c6_4,text_c6_4, getty_c6_4)">Selected Version: Getty</option> \
		...
		$(\'#note_c6_4\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c6_4\",$(\'#note_c6_4\').val());\
			$(\'#note_c6_4\').val(localStorage.getItem(\"morgan_mounted_c6_4\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.007rb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c6_5"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c6_5" id="menu_c6_5" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected"  value="img/morgan-images/m383.007rb.jpg" onclick = "swap_picture(c6_5, menu_c6_5,text_c6_5, morgan_c6_5)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_45r1.jpg" onclick = "swap_picture(c6_5, menu_c6_5,text_c6_5, getty_c6_5)">Selected Version: Getty</option> \
		...
		$(\'#note_c6_5\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c6_5\",$(\'#note_c6_5\').val());\
			$(\'#note_c6_5\').val(localStorage.getItem(\"morgan_mounted_c6_5\"));\
		});\
		</script><br>';
...
function morgan_mounted7(){
	...
	if ($('#c7_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.007va.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c7_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c7_1" id="menu_c7_1" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.007va.jpg" onclick = "swap_picture(c7_1, menu_c7_1,text_c7_1, morgan_c7_1)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_45r2.jpg" onclick = "swap_picture(c7_1, menu_c7_1,text_c7_1, getty_c7_1)">Selected Version: Getty</option> \
		...
		$(\'#note_c7_1\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c7_1\",$(\'#note_c7_1\').val());\
			$(\'#note_c7_1\').val(localStorage.getItem(\"morgan_mounted_c7_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.007vb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c7_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c7_2" id="menu_c7_2" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected"  value="img/morgan-images/m383.007vb.jpg" onclick = "swap_picture(c7_2, menu_c7_2,text_c7_2, morgan_c7_2)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_45r3.jpg" onclick = "swap_picture(c7_2, menu_c7_2,text_c7_2, getty_c7_2)">Selected Version: Getty</option> \
		...
		$(\'#note_c7_2\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c7_2\",$(\'#note_c7_2\').val());\
			$(\'#note_c7_2\').val(localStorage.getItem(\"morgan_mounted_c7_2\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.007vc.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c7_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c7_3" id="menu_c7_3" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.007vc.jpg" onclick = "swap_picture(c7_3, menu_c7_3,text_c7_3, morgan_c7_3)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_45r4.jpg" onclick = "swap_picture(c7_3, menu_c7_3,text_c7_3, getty_c7_3)">Selected Version: Getty</option> \
		...
		$(\'#note_c7_3\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c7_3\",$(\'#note_c7_3\').val());\
			$(\'#note_c7_3\').val(localStorage.getItem(\"morgan_mounted_c7_3\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.007vd.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c7_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c7_4" id="menu_c7_4" data-mini="true" stlye = "padding-left: 15%;"> \
				<option  selected="selected" value="img/morgan-images/m383.007vd.jpg" onclick = "swap_picture(c7_4, menu_c7_4,text_c7_4, morgan_c7_4)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_45v1.jpg" onclick = "swap_picture(c7_4, menu_c7_4,text_c7_4, getty_c7_4)">Selected Version: Getty</option> \
		...
		$(\'#note_c7_4\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c7_4\",$(\'#note_c7_4\').val());\
			$(\'#note_c7_4\').val(localStorage.getItem(\"morgan_mounted_c7_4\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.008ra.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c7_5"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c7_5" id="menu_c7_5" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.008ra.jpg" onclick = "swap_picture(c7_5, menu_c7_5,text_c7_5, morgan_c7_5)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_45v2.jpg" onclick = "swap_picture(c7_5, menu_c7_5,text_c7_5, getty_c7_5)">Selected Version: Getty</option> \
		...
		$(\'#note_c7_5\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c7_5\",$(\'#note_c7_5\').val());\
			$(\'#note_c7_5\').val(localStorage.getItem(\"morgan_mounted_c7_5\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.008ra.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c7_6"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c7_6" id="menu_c7_6" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected"  value="img/morgan-images/m383.008ra.jpg" onclick = "swap_picture(c7_6, menu_c7_6,text_c7_6, morgan_c7_6)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_45v3.jpg" onclick = "swap_picture(c7_6, menu_c7_6,text_c7_6, getty_c7_6)">Selected Version: Getty</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c7_6\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c7_6\",$(\'#note_c7_6\').val());\
			$(\'#note_c7_6\').val(localStorage.getItem(\"morgan_mounted_c7_6\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.008rb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c7_7"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c7_7" id="menu_c7_7" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected"  value="img/morgan-images/m383.008rb.jpg" onclick = "swap_picture(c7_7, menu_c7_7,text_c7_7, morgan_c7_7)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_45v4.jpg" onclick = "swap_picture(c7_7, menu_c7_7,text_c7_7, getty_c7_7)">Selected Version: Getty</option> \
		...
		$(\'#note_c7_7\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c7_7\",$(\'#note_c7_7\').val());\
			$(\'#note_c7_7\').val(localStorage.getItem(\"morgan_mounted_c7_7\"));\
		});\
		</script><br>';
...
function morgan_mounted8(){
	...
	if ($('#c8_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.008rc.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c8_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c8_1" id="menu_c8_1" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.008rc.jpg" onclick = "swap_picture(c8_1, menu_c8_1,text_c8_1, morgan_c8_1)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_46r1.jpg" onclick = "swap_picture(c8_1, menu_c8_1,text_c8_1, getty_c8_1)">Selected Version: Getty</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c8_1\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c8_1\",$(\'#note_c8_1\').val());\
			$(\'#note_c8_1\').val(localStorage.getItem(\"morgan_mounted_c8_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.008rd.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c8_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c8_2" id="menu_c8_2" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.008rd.jpg" onclick = "swap_picture(c8_2, menu_c8_2,text_c8_2, morgan_c8_2)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_46r2.jpg" onclick = "swap_picture(c8_2, menu_c8_2,text_c8_2, getty_c8_2)">Selected Version: Getty</option> \
		...
		$(\'#note_c8_2\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c8_2\",$(\'#note_c8_2\').val());\
			$(\'#note_c8_2\').val(localStorage.getItem(\"morgan_mounted_c8_2\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.008va.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c8_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c8_3" id="menu_c8_3" data-mini="true" stlye = "padding-left: 15%;"> \
				<option  selected="selected" value="img/morgan-images/m383.008va.jpg" onclick = "swap_picture(c8_3, menu_c8_3,text_c8_3, morgan_c8_3)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_46r3.jpg" onclick = "swap_picture(c8_3, menu_c8_3,text_c8_3, getty_c8_3)">Selected Version: Getty</option> \
		...
		$(\'#note_c8_3\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c8_3\",$(\'#note_c8_3\').val());\
			$(\'#note_c8_3\').val(localStorage.getItem(\"morgan_mounted_c8_3\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.008vb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c8_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c8_4" id="menu_c8_4" data-mini="true" stlye = "padding-left: 15%;"> \
				<option  selected="selected" value="img/morgan-images/m383.008vb.jpg" onclick = "swap_picture(c8_4, menu_c8_4,text_c8_4, morgan_c8_4)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_46r4.jpg" onclick = "swap_picture(c8_4, menu_c8_4,text_c8_4, getty_c8_4)">Selected Version: Getty</option> \
		...
		$(\'#note_c8_4\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c8_4\",$(\'#note_c8_4\').val());\
			$(\'#note_c8_4\').val(localStorage.getItem(\"morgan_mounted_c8_4\"));\
		});\
		</script><br>';
...
function morgan_mounted9(){
	...
	if ($('#c9_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/missing.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c9_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c9_1" id="menu_c9_1" data-mini="true" stlye = "padding-left: 15%;"> \
				<option  selected="selected" value="img/morgan-images/missing.jpg" onclick = "swap_picture(c9_1, menu_c9_1,text_c9_1, morgan_c9_1)">Selected Version: Morgan</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_46v1.jpg" onclick = "swap_picture(c9_1, menu_c9_1,text_c9_1, getty_c9_1)">Selected Version: Getty</option> \
		...
		$(\'#note_c9_1\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_mounted_c9_1\",$(\'#note_c9_1\').val());\
			$(\'#note_c9_1\').val(localStorage.getItem(\"morgan_mounted_c9_1\"));\
		});\
		</script><br>';
		...
		//append changes
		$('#sub9').empty().append(c9_1 + menu_c9_1);
		$('.ui-page-active').page("destroy").page(); 
		$('#morgan_c9_1').show();
		$('#note_c9_1').val(localStorage.getItem("morgan_mounted_c9_1"));
