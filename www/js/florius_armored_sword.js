...
function florius_armored_sword1(){
	...
	if ($('#c1_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f35.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_1" id="menu_c1_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f35.highresa.jpg" onclick = "swap_picture(\'c1_1\', menu_c1_1,text_c1_1, florius_text_c1_1)">Selected Version: Floris</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_34v2.jpg" onclick = "swap_picture(\'c1_1\', menu_c1_1,text_c1_1, getty_c1_1)">Selected Version: Getty</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_26a2.jpg" onclick = "swap_picture(\'c1_1\', menu_c1_1,text_c1_1, pd_text_c1_1)">Selected Version: Pisani-Dossi</option> \
				<option  value="img/morgan-images/m383.011rb.jpg" onclick = "swap_picture(\'c1_1\', menu_c1_1,text_c1_1, morgan_c1_1)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c1_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c1_1\",$(\'#note_c1_1\').val());\
			$(\'#note_c1_1\').val(localStorage.getItem(\"florius_armoredls_c1_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f35.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_2" id="menu_c1_2" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f35.highresb.jpg" onclick = "swap_picture(\'c1_2\', menu_c1_2,text_c1_2, florius_text_c1_2)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_34v3.jpg" onclick = "swap_picture(\'c1_2\', menu_c1_2,text_c1_2, getty_c1_2)">Selected Version: Getty</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_26a3.jpg" onclick = "swap_picture(\'c1_2\', menu_c1_2,text_c1_2, pd_text_c1_2)">Selected Version: Pisani-Dossi</option> \
				<option value="img/morgan-images/m383.011rc.jpg" onclick = "swap_picture(\'c1_2\', menu_c1_2,text_c1_2, morgan_c1_2)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f36.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_3" id="menu_c1_3" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f36.highresa.jpg" onclick = "swap_picture(\'c1_3\', menu_c1_3,text_c1_3, florius_text_c1_3)">Selected Version: Floris</option> \
				<option  value="img/morgan-images/m383.011rd.jpg" onclick = "swap_picture(\'c1_3\', menu_c1_3,text_c1_3, morgan_c1_3)">Selected Version: Morgan</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_26a4.jpg" onclick = "swap_picture(\'c1_3\', menu_c1_3,text_c1_3, pd_text_c1_3)">Selected Version: Pisani-Dossi</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c1_3\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c1_3\",$(\'#note_c1_3\').val());\
			$(\'#note_c1_3\').val(localStorage.getItem(\"florius_armoredls_c1_3\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f36.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_4" id="menu_c1_4" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f36.highresb.jpg" onclick = "swap_picture(\'c1_4\', menu_c1_4,text_c1_4, florius_text_c1_4)">Selected Version: Floris</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_26b1.jpg" onclick = "swap_picture(\'c1_4\', menu_c1_4,text_c1_4, pd_text_c1_4)">Selected Version: Pisani-Dossi</option> \
				<option  value="img/morgan-images/m383.011va.jpg" onclick = "swap_picture(\'c1_4\', menu_c1_4,text_c1_4, morgan_c1_4)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c1_4\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c1_4\",$(\'#note_c1_4\').val());\
			$(\'#note_c1_4\').val(localStorage.getItem(\"florius_armoredls_c1_4\"));\
		});\
		</script><br>';
		...
		$('#florius_text_c1_6').show();
		$('#note_c1_1').val(localStorage.getItem("florius_armoredls_c1_1"));
		$('#note_c1_2').val(localStorage.getItem("florius_armoredls_c1_2"));
		$('#note_c1_3').val(localStorage.getItem("florius_armoredls_c1_3"));
		$('#note_c1_4').val(localStorage.getItem("florius_armoredls_c1_4"));
...
//1st master, scholars 5-8
function florius_armored_sword2(){
	...
	if ($('#c2_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f37.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_1" id="menu_c2_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f37.highresa.jpg" onclick = "swap_picture(\'c2_1\', menu_c2_1,text_c2_1, florius_text_c2_1)">Selected Version: Floris</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_26b2.jpg" onclick = "swap_picture(\'c2_1\', menu_c2_1,text_c2_1, pd_text_c2_1)">Selected Version: Pisani-Dossi</option> \
				<option  value="img/morgan-images/m383.011vb.jpg" onclick = "swap_picture(\'c2_1\', menu_c2_1,text_c2_1, morgan_c2_1)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c2_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c2_1\",$(\'#note_c2_1\').val());\
			$(\'#note_c2_1\').val(localStorage.getItem(\"florius_armoredls_c2_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f37.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_2" id="menu_c2_2" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f37.highresb.jpg" onclick = "swap_picture(\'c2_2\', menu_c2_2,text_c2_2, florius_text_c2_2)">Selected Version: Floris</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_26b3.jpg" onclick = "swap_picture(\'c2_2\', menu_c2_2,text_c2_2, pd_text_c2_2)">Selected Version: Pisani-Dossi</option> \
				<option  value="img/morgan-images/m383.011vc.jpg" onclick = "swap_picture(\'c2_2\', menu_c2_2,text_c2_2, morgan_c2_2)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c2_2\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c2_2\",$(\'#note_c2_2\').val());\
			$(\'#note_c2_2\').val(localStorage.getItem(\"florius_armoredls_c2_2\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f38.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_3" id="menu_c2_3" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f38.highresa.jpg" onclick = "swap_picture(\'c2_3\', menu_c2_3,text_c2_3, florius_text_c2_3)">Selected Version: Floris</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_26b4.jpg" onclick = "swap_picture(\'c2_3\', menu_c2_3,text_c2_3, pd_text_c2_3)">Selected Version: Pisani-Dossi</option> \
				<option  value="img/morgan-images/m383.011vd.jpg" onclick = "swap_picture(\'c2_3\', menu_c2_3,text_c2_3, morgan_c2_3)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c2_3\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c2_3\",$(\'#note_c2_3\').val());\
			$(\'#note_c2_3\').val(localStorage.getItem(\"florius_armoredls_c2_3\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f38.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_4" id="menu_c2_4" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f38.highresb.jpg" onclick = "swap_picture(\'c2_4\', menu_c2_4,text_c2_4, florius_text_c2_4)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_33v3.jpg" onclick = "swap_picture(\'c2_4\', menu_c2_4,text_c2_4, getty_c2_4)">Selected Version: Getty</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$('#note_c2_2').val(localStorage.getItem("florius_armoredls_c2_2"));
		$('#note_c2_3').val(localStorage.getItem("florius_armoredls_c2_3"));
		$('#note_c2_4').val(localStorage.getItem("florius_armoredls_c2_4"));
		
	}
}


//Armored stances part I
function florius_armored_sword3(){
	...
	if ($('#c3_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f39.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c3_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c3_1" id="menu_c3_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected"  value="img/florius-images/f39.highresa.jpg" onclick = "swap_picture(\'c3_1\', menu_c3_1,text_c3_1, florius_text_c3_1)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_32v3.jpg" onclick = "swap_picture(\'c3_1\', menu_c3_1,text_c3_1, getty_c3_1)">Selected Version: Getty</option> \
				<option   value="img/PD-images/1024px-Pisani-Dossi_MS_25a4.jpg" onclick = "swap_picture(\'c3_1\', menu_c3_1,text_c3_1, pd_text_c3_1)">Selected Version: Pisani-Dossi</option> \
				<option   value="img/morgan-images/m383.010rc.jpg" onclick = "swap_picture(\'c3_1\', menu_c3_1,text_c3_1, morgan_c3_1)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c3_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c3_1\",$(\'#note_c3_1\').val());\
			$(\'#note_c3_1\').val(localStorage.getItem(\"florius_armoredls_c3_1\"));\
		});\
		</script><br>';
		...
		var c3_2= '\
		<h2 style = "padding-left: 5%">Aspecto Leopardi (Leopard Guard)</h2>\
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f39.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c3_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c3_2" id="menu_c3_2" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option  selected="selected" value="img/florius-images/f39.highresa.jpg" onclick = "swap_picture(\'c3_2\', menu_c3_2,text_c3_2, florius_text_c3_2)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_32v2.jpg" onclick = "swap_picture(\'c3_2\', menu_c3_2,text_c3_2, getty_c3_2)">Selected Version: Getty</option> \
				<option   value="img/PD-images/1024px-Pisani-Dossi_MS_25a3.jpg" onclick = "swap_picture(\'c3_2\', menu_c3_2,text_c3_2, pd_text_c3_2)">Selected Version: Pisani-Dossi</option> \
				<option   value="img/morgan-images/m383.010rb.jpg" onclick = "swap_picture(\'c3_2\', menu_c3_2,text_c3_2, morgan_c3_2)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c3_2\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c3_2\",$(\'#note_c3_2\').val());\
			$(\'#note_c3_2\').val(localStorage.getItem(\"florius_armoredls_c3_2\"));\
		});\
		</script><br>';
...
//1st master, scholars 12-14
function florius_armored_sword4(){
	...
	if ($('#c4_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f39.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_1" id="menu_c4_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f39.highresb.jpg" onclick = "swap_picture(\'c4_1\', menu_c4_1,text_c4_1, florius_text_c4_1)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_33r3.jpg" onclick = "swap_picture(\'c4_1\', menu_c4_1,text_c4_1, getty_c4_1)">Selected Version: Getty</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_25b3.jpg" onclick = "swap_picture(\'c4_1\', menu_c4_1,text_c4_1, pd_text_c4_1)">Selected Version: Pisani-Dossi</option> \
				<option value="img/morgan-images/m383.010vc.jpg" onclick = "swap_picture(\'c4_1\', menu_c4_1,text_c4_1, morgan_c4_1)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c4_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c4_1\",$(\'#note_c4_1\').val());\
			$(\'#note_c4_1\').val(localStorage.getItem(\"florius_armoredls_c4_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f40.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_2" id="menu_c4_2" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f40.highresa.jpg" onclick = "swap_picture(\'c4_2\', menu_c4_2,text_c4_2, florius_text_c4_2)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_33r4.jpg" onclick = "swap_picture(\'c4_2\', menu_c4_2,text_c4_2, getty_c4_2)">Selected Version: Getty</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_25b4.jpg" onclick = "swap_picture(\'c4_2\', menu_c4_2,text_c4_2, pd_text_c4_2)">Selected Version: Pisani-Dossi</option> \
				<option  value="img/morgan-images/m383.010vd.jpg" onclick = "swap_picture(\'c4_2\', menu_c4_2,text_c4_2, morgan_c4_2)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c4_2\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c4_2\",$(\'#note_c4_2\').val());\
			$(\'#note_c4_2\').val(localStorage.getItem(\"florius_armoredls_c4_2\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f40.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_3" id="menu_c4_3" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f40.highresb.jpg" onclick = "swap_picture(\'c4_3\', menu_c4_3,text_c4_3, florius_text_c4_3)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_34r1.jpg" onclick = "swap_picture(\'c4_3\', menu_c4_3,text_c4_3, getty_c4_3)">Selected Version: Getty</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_26a1.jpg" onclick = "swap_picture(\'c4_3\', menu_c4_3,text_c4_3, pd_text_c4_3)">Selected Version: Pisani-Dossi</option> \
				<option value="img/morgan-images/m383.011ra.jpg" onclick = "swap_picture(\'c4_3\', menu_c4_3,text_c4_3, morgan_c4_3)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c4_3\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c4_3\",$(\'#note_c4_3\').val());\
			$(\'#note_c4_3\').val(localStorage.getItem(\"florius_armoredls_c4_3\"));\
		});\
		</script><br>';
...
//armored stances part II
function florius_armored_sword5(){
	...
	if ($('#c5_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f42.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_1" id="menu_c5_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option  selected="selected" value="img/florius-images/f42.highresa.jpg" onclick = "swap_picture(\'c5_1\', menu_c5_1,text_c5_1, florius_text_c5_1)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_32v1.jpg" onclick = "swap_picture(\'c5_1\', menu_c5_1,text_c5_1, getty_c5_1)">Selected Version: Getty</option> \
				<option   value="img/PD-images/1024px-Pisani-Dossi_MS_25a2.jpg" onclick = "swap_picture(\'c5_1\', menu_c5_1,text_c5_1, pd_text_c5_1)">Selected Version: Pisani-Dossi</option> \
				<option   value="img/morgan-images/m383.010ra.jpg" onclick = "swap_picture(\'c5_1\', menu_c5_1,text_c5_1, morgan_c5_1)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c5_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c5_1\",$(\'#note_c5_1\').val());\
			$(\'#note_c5_1\').val(localStorage.getItem(\"florius_armoredls_c5_1\"));\
		});\
		</script><br>';
		...
		var c5_2= '\
		<h2 style = "padding-left: 5%">Vera Croce (Guard of the Bastard Cross in other Manuscripts)</h2>\
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f42.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_2" id="menu_c5_2" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option  selected="selected" value="img/florius-images/f42.highresa.jpg" onclick = "swap_picture(\'c5_2\', menu_c5_2,text_c5_2, florius_text_c5_2)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_33r2.jpg" onclick = "swap_picture(\'c5_2\', menu_c5_2,text_c5_2, getty_c5_2)">Selected Version: Getty</option> \
				<option   value="img/PD-images/1024px-Pisani-Dossi_MS_25b2.jpg" onclick = "swap_picture(\'c5_2\', menu_c5_2,text_c5_2, pd_text_c5_2)">Selected Version: Pisani-Dossi</option> \
				<option   value="img/morgan-images/m383.010vb.jpg" onclick = "swap_picture(\'c5_2\', menu_c5_2,text_c5_2, morgan_c5_2)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c5_2\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c5_2\",$(\'#note_c5_2\').val());\
			$(\'#note_c5_2\').val(localStorage.getItem(\"florius_armoredls_c5_2\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f42.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_3" id="menu_c5_3" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option  selected="selected" value="img/florius-images/f42.highresb.jpg" onclick = "swap_picture(\'c5_3\', menu_c5_3,text_c5_3, florius_text_c5_3)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_33r1.jpg" onclick = "swap_picture(\'c5_3\', menu_c5_3,text_c5_3, getty_c5_3)">Selected Version: Getty</option> \
				<option   value="img/PD-images/1024px-Pisani-Dossi_MS_25b1.jpg" onclick = "swap_picture(\'c5_3\', menu_c5_3,text_c5_3, pd_text_c5_3)">Selected Version: Pisani-Dossi</option> \
				<option   value="img/morgan-images/m383.010va.jpg" onclick = "swap_picture(\'c5_3\', menu_c5_3,text_c5_3, morgan_c5_3)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c5_3\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c5_3\",$(\'#note_c5_3\').val());\
			$(\'#note_c5_3\').val(localStorage.getItem(\"florius_armoredls_c5_3\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f42.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_4" id="menu_c5_4" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option  selected="selected" value="img/florius-images/f42.highresb.jpg" onclick = "swap_picture(\'c5_4\', menu_c5_4,text_c5_4, florius_text_c5_4)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_32v4.jpg" onclick = "swap_picture(\'c5_4\', menu_c5_4,text_c5_4, getty_c5_4)">Selected Version: Getty</option> \
				<option   value="img/PD-images/1024px-Pisani-Dossi_MS_25a5.jpg" onclick = "swap_picture(\'c5_4\', menu_c5_4,text_c5_4, pd_text_c5_4)">Selected Version: Pisani-Dossi</option> \
				<option   value="img/morgan-images/m383.010r.jpg" onclick = "swap_picture(\'c5_4\', menu_c5_4,text_c5_4, morgan_c5_4)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c5_4\').on(\'change\', function(){\
			localStorage.setItem(\"florius_armoredls_c5_4\",$(\'#note_c5_4\').val());\
			$(\'#note_c5_4\').val(localStorage.getItem(\"florius_armoredls_c5_4\"));\
		});\
		</script><br>';
