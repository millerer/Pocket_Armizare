...
//1st master
function morgan_dagger_sword_1(){
	...
	if ($('#c1_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.018r4.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_1" id="menu_c1_1" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.018r4.jpg" onclick = "swap_picture(c1_1, menu_c1_1,text_c1_1, morgan_c1_1)">Selected Version: Morgan</option> \
		...
		$(\'#note_c1_1\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_daggerSword_c1_1\",$(\'#note_c1_1\').val());\
			$(\'#note_c1_1\').val(localStorage.getItem(\"morgan_daggerSword_c1_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.018v1.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_2" id="menu_c1_2" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.018v1.jpg" onclick = "swap_picture(c1_2, menu_c1_2,text_c1_2, morgan_c1_2)">Selected Version: Morgan</option> \
		...
		$(\'#note_c1_2\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_daggerSword_c1_2\",$(\'#note_c1_2\').val());\
			$(\'#note_c1_2\').val(localStorage.getItem(\"morgan_daggerSword_c1_2\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.018v2.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_3" id="menu_c1_3" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.018v2.jpg" onclick = "swap_picture(c1_3, menu_c1_3,text_c1_3, morgan_c1_3)">Selected Version: Morgan</option> \
		...
		$(\'#note_c1_3\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_daggerSword_c1_3\",$(\'#note_c1_3\').val());\
			$(\'#note_c1_3\').val(localStorage.getItem(\"morgan_daggerSword_c1_3\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.018v3.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_4" id="menu_c1_4" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.018v3.jpg" onclick = "swap_picture(c1_4, menu_c1_4,text_c1_4, morgan_c1_4)">Selected Version: Morgan</option> \
		...
		$(\'#note_c1_4\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_daggerSword_c1_4\",$(\'#note_c1_4\').val());\
			$(\'#note_c1_4\').val(localStorage.getItem(\"morgan_daggerSword_c1_4\"));\
		});\
		</script><br>';
...
//2nd master
function morgan_dagger_sword_2(){
	...
	if ($('#c2_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.018v4.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_1" id="menu_c2_1" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.018v4.jpg" onclick = "swap_picture(c2_1, menu_c2_1,text_c2_1, morgan_c2_1)">Selected Version: Morgan</option> \
		...
		$(\'#note_c2_1\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_daggerSword_c2_1\",$(\'#note_c2_1\').val());\
			$(\'#note_c2_1\').val(localStorage.getItem(\"morgan_daggerSword_c2_1\"));\
		});\
		</script><br>';
		...
		<h2 style = "padding-left: 5%">1st Scholar</h2>\
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/morgan-images/m383.017ra.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_2" id="menu_c2_2" data-mini="true" stlye = "padding-left: 15%;"> \
				<option selected="selected" value="img/morgan-images/m383.017ra.jpg" onclick = "swap_picture(c2_2, menu_c2_2,text_c2_2, morgan_c2_2)">Selected Version: Morgan</option> \
		...
		$(\'#note_c2_2\').on(\'change\', function(){\
			localStorage.setItem(\"morgan_daggerSword_c2_2\",$(\'#note_c2_2\').val());\
			$(\'#note_c2_2\').val(localStorage.getItem(\"morgan_daggerSword_c2_2\"));\
		});\
		</script><br>';
