...
function florius_principles(){
	...
	if ($('#c1_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f6.highres.jpeg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_1" id="menu_c1_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f6.highres.jpeg" onclick = "swap_picture(\'c1_1\', menu_c1_1,text_c1_1, florius_text_c1_1)">Selected Version: Florius</option> \
		...
		$(\'#note_c1_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_principles_c1_1\",$(\'#note_c1_1\').val());\
			$(\'#note_c1_1\').val(localStorage.getItem(\"florius_principles_c1_1\"));\
		});\
		</script><br><br>';
