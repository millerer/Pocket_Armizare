...
function getty_introduction_1(){
	...
	if ($('#c1_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/getty-images/1024px-MS_Ludwig_XV_13_01r.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_1" id="menu_c1_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/getty-images/1024px-MS_Ludwig_XV_13_01r.jpg" onclick = "swap_picture(\'c1_1, menu_c1_1,text_c1_1, getty_c1_1)">Selected Version: Getty</option> \
		...
		$(\'#note_c1_1\').on(\'change\', function(){\
			localStorage.setItem(\"getty_intro_c1_1\",$(\'#note_c1_1\').val());\
			$(\'#note_c1_1\').val(localStorage.getItem(\"getty_intro_c1_1\"));\
		});\
		</script><br><br>';
...
function getty_introduction_2(){
	...
	if ($('#c2_1').length > 0){
		...
		var c2_1= '\
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/getty-images/1024px-MS_Ludwig_XV_13_01r.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_1" id="menu_c2_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/getty-images/1024px-MS_Ludwig_XV_13_01r.jpg" onclick = "swap_picture(\'c2_1, menu_c2_1,text_c2_1, getty_c2_1)">Selected Version: Getty</option> \
				<option value="img/morgan-images/m383.001r.jpg" onclick = "swap_picture(\'c2_1, menu_c2_1, text_c2_1, morgan_c2_1)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c2_1\').on(\'change\', function(){\
			localStorage.setItem(\"getty_intro_c2_1\",$(\'#note_c2_1\').val());\
			$(\'#note_c2_1\').val(localStorage.getItem(\"getty_intro_c2_1\"));\
		});\
		</script><br><br>';
...
function getty_introduction_3(){
	...
	if ($('#c3_1').length > 0){
		...
		var c3_1= '\
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/getty-images/1024px-MS_Ludwig_XV_13_01v.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c3_1"> \
		</div>';
	...
	\
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c3_1" id="menu_c3_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/getty-images/1024px-MS_Ludwig_XV_13_01v.jpg" onclick = "swap_picture(\'c3_1, menu_c3_1, text_c3_1, getty_c3_1)">Selected Version: Getty</option> \
				<option value="img/morgan-images/MS_M.383_1v.png" onclick = "swap_picture(\'c3_1,menu_c3_1, text_c3_1, morgan_c3_1)">Selected Version: Morgan</option> \
		...
		$(\'#note_c1_2\').on(\'change\', function(){\
			localStorage.setItem(\"getty_intro_c3_1\",$(\'#note_c3_1\').val());\
			$(\'#note_c3_1\').val(localStorage.getItem(\"getty_intro_c3_1\"));\
		});\
		</script><br><br>';
...
function getty_introduction_4(){
	...
	if ($('#c4_1').length > 0){
		...
		var c4_1= '\
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/getty-images/1024px-MS_Ludwig_XV_13_01v.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_1" id="menu_c4_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/getty-images/1024px-MS_Ludwig_XV_13_01v.jpg" onclick = "swap_picture(\'c4_1, menu_c4_1, text_c4_1, getty_c4_1)">Selected Version: Getty</option> \
				<option value="img/morgan-images/MS_M.383_1v.png" onclick = "swap_picture(\'c4_1,menu_c4_1,text_c4_1, morgan_c4_1)">Selected Version: Morgan</option> \
		...
		$(\'#note_c4_1\').on(\'change\', function(){\
			localStorage.setItem(\"getty_intro_c4_1\",$(\'#note_c4_1\').val());\
			$(\'#note_c4_1\').val(localStorage.getItem(\"getty_intro_c4_1\"));\
		});\
		</script><br><br>';
...
//fith section: unarmed intro
function getty_introduction_5(){
	...
	if ($('#c5_1').length > 0){
		...
		//image file for unarmed intro
		var c5_1= '\
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/getty-images/1024px-MS_Ludwig_XV_13_02r.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_1"> \
		</div>';
		
		//image text for unarmed intro
		...
		In which gloss we will speak with all our knowledge, and first we will speak of the grappling on foot, and then of the other matters of fencing, following that \
		which you will see painted and ordered by the foresaid Fiore.\
		\
		...
		following that which you will see in the painted figures, and especially in plays that will gain holds, each one with its knowledge and with its malice. Because in \
		...
		//image swap menu for unarmed intro
		var menu_c5_1 = '\
		<form style="width:80%; text-align:center; padding-left: 20%;"> \
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_1" id="menu_c5_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/getty-images/1024px-MS_Ludwig_XV_13_02r.jpg" onclick = "swap_picture(\'c5_1, menu_c5_1, text_c5_1, getty_c5_1)">Selected Version: Getty</option> \
		...
		//Note section for unarmed intro. 
		...
		$(\'#note_c5_1\').on(\'change\', function(){\
			localStorage.setItem(\"getty_intro_c5_1\",$(\'#note_c5_1\').val());\
			$(\'#note_c5_1\').val(localStorage.getItem(\"getty_intro_c5_1\"));\
		});\
		</script><br><br>';
...
function getty_introduction_6(){
	...
	if ($('#c6_1').length > 0){
		...
		var c6_1= '\
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/getty-images/1024px-MS_Ludwig_XV_13_02r.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c6_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c6_1" id="menu_c6_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/getty-images/1024px-MS_Ludwig_XV_13_02r.jpg" onclick = "swap_picture(\'c6_1, menu_c6_1, text_c6_1, getty_c6_1)">Selected Version: Getty</option> \
				<option value="img/PD-images/1024px-Pisani-Dossi_MS_02a.jpg" onclick = "swap_picture(\'c6_1,menu_c6_1, text_c6_1,  pd_textb_c6_1)">Selected Version: Pisani-Dossi Itallian Intro</option> \
				<option value="img/morgan-images/MS_M.383_2r.png" onclick = "swap_picture(\'c6_1,menu_c6_1, text_c6_1,  morgan_c6_1)">Selected Version: Morgan</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c6_1\').on(\'change\', function(){\
			localStorage.setItem(\"getty_intro_c6_1\",$(\'#note_c6_1\').val());\
			$(\'#note_c6_1\').val(localStorage.getItem(\"getty_intro_c6_1\"));\
		});\
		</script><br><br>';
...
//seventh section: adaptability 
function getty_introduction_7(){
	...
	if ($('#c7_1').length > 0){
		...
		//image file for adaptability
		var c7_1= '\
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/getty-images/1024px-MS_Ludwig_XV_13_01v.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c7_1"> \
		</div>';

		//image text
		
		var getty_text = '<div id = getty_c7_1 style="display: none;">\
		As we have talked before about the guards of unarmed combat and about the second master, the remedy and his players, about the third master contrary to the \
		second master and his players, and about the third master contrary to the second master and his players, and the fourth master called contra-contrary. \
		\
		<br><br>In the same way as these masters and players have to manage the art of wrestling in and out of armour, they have to manage the art of fighting with\
		spears and their guards. Likewise with axe and sword (one and two handed), and the same way with the dagger.\
		\
		<br><br>As a consequence, the masters and players mentioned before, with their signs and garments, have to manage the whole art of combat on foot and mounted, \
		with and without armour as they do in wrestling. And this means that the guards and masters in other arts, remedies, and contraries can only be performed in this\
		way such as in unarmed combat. In this way the book may be easily interpreted. Because the rubrics, the pictures, and the plays show the whole art in such a good\
		way that it will be possible to understand it all. \
		\
		<br><br>Now, let us attend to the drawn pictures and to their plays and their words, which will show the truth.\
		</div>';
		...
		//image swap menu for adaptability
		var menu_c7_1 = '\
		<form style="width:80%; text-align:center; padding-left: 20%;"> \
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c7_1" id="menu_c7_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/getty-images/1024px-MS_Ludwig_XV_13_02r.jpg" onclick = "swap_picture(\'c7_1, menu_c7_1, text_c7_1, getty_c7_1)">Selected Version: Getty</option> \
			</select> \
		</div> \
		</form>\
		\
	<br><div style ="padding-left:5%;  padding-right:5%;"  id = text_c7_1>'+getty_text+ morgan_text + pd_texta +pd_textb+'\
		...
		$(\'#note_c7_1\').on(\'change\', function(){\
			localStorage.setItem(\"getty_intro_c7_1\",$(\'#note_c7_1\').val());\
			$(\'#note_c7_1\').val(localStorage.getItem(\"getty_intro_c7_1\"));\
		});\
		</script><br><br>';
