...
function florius_unarmed_1(){
	...
	if ($('#c1_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f80a.highres.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_1" id="menu_c1_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f80a.highres.jpg" onclick = "swap_picture(\'c1_1,menu_c1_1,text_c1_1, florius_text_c1_1);">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_06r-2.jpg" onclick = "swap_picture(\'c1_1\', menu_c1_1,text_c1_1, getty_c1_1)">Selected Version: Getty</option> \
				<option value="img/PD-images/1024px-Pisani-Dossi_MS_04a2.jpg" onclick = "swap_picture(\'c1_1,menu_c1_1,text_c1_1, pd_text_c1_1);">Selected Version: Pisani-Dossi</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c1_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c1_1\",$(\'#note_c1_1\').val());\
			$(\'#note_c1_1\').val(localStorage.getItem(\"florius_unarmed_c1_1\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f80b.highres.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_2" id="menu_c1_2" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f80b.highres.jpg" onclick = "swap_picture(\'c1_2,menu_c1_2,text_c1_2, florius_text_c1_2);">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_06r-1.jpg" onclick = "swap_picture(\'c1_2\', menu_c1_2,text_c1_2, getty_c1_2)">Selected Version: Getty</option> \
				<option value="img/PD-images/1024px-Pisani-Dossi_MS_04a1.jpg" onclick = "swap_picture(\'c1_2,menu_c1_2,text_c1_2, pd_text_c1_2);">Selected Version: Pisani-Dossi</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c1_2\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c1_2\",$(\'#note_c1_2\').val());\
			$(\'#note_c1_2\').val(localStorage.getItem(\"florius_unarmed_c1_2\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f80c.highres.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_3" id="menu_c1_3" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f80c.highres.jpg" onclick = "swap_picture(\'c1_3,menu_c1_3,text_c1_3, florius_text_c1_3);">Selected Version: Florius</option> \
		...
		$(\'#note_c1_3\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c1_3\",$(\'#note_c1_3\').val());\
			$(\'#note_c1_3\').val(localStorage.getItem(\"florius_unarmed_c1_3\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f80d.highres.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_4" id="menu_c1_4" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f80d.highres.jpg" onclick = "swap_picture(\'c1_4,menu_c1_4,text_c1_4, florius_text_c1_4);">Selected Version: Florius</option> \
		...
		$(\'#note_c1_4\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c1_4\",$(\'#note_c1_4\').val());\
			$(\'#note_c1_4\').val(localStorage.getItem(\"florius_unarmed_c1_4\"));\
		});\
		</script><br><br>';
...
function florius_unarmed_2(){
	...
	if ($('#c2_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f81a.highres.jpeg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_1" id="menu_c2_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f81a.highres.jpeg" onclick = "swap_picture(\'c2_1,menu_c2_1,text_c2_1, florius_text_c2_1);">Selected Version: Florius</option> \
		...
		$(\'#note_c2_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c2_1\",$(\'#note_c2_1\').val());\
			$(\'#note_c2_1\').val(localStorage.getItem(\"florius_unarmed_c2_1\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f81b.highres.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_2" id="menu_c2_2" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f81b.highres.jpg" onclick = "swap_picture(\'c2_2,menu_c2_2,text_c2_2, florius_text_c2_2);">Selected Version: Florius</option> \
		...
		$(\'#note_c2_2\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c2_2\",$(\'#note_c2_2\').val());\
			$(\'#note_c2_2\').val(localStorage.getItem(\"florius_unarmed_c2_2\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f82a.highres.jpeg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_3" id="menu_c2_3" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f82a.highres.jpeg" onclick = "swap_picture(\'c2_3,menu_c2_3,text_c2_3, florius_text_c2_3);">Selected Version: Florius</option> \
		...
		$(\'#note_c2_3\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c2_3\",$(\'#note_c2_3\').val());\
			$(\'#note_c2_3\').val(localStorage.getItem(\"florius_unarmed_c2_3\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f82b.highres.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_4" id="menu_c2_4" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f82b.highres.jpg" onclick = "swap_picture(\'c2_4,menu_c2_4,text_c2_4, florius_text_c2_4);">Selected Version: Florius</option> \
		...
		$(\'#note_c2_4\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c2_4\",$(\'#note_c2_4\').val());\
			$(\'#note_c2_4\').val(localStorage.getItem(\"florius_unarmed_c2_4\"));\
		});\
		</script><br><br>';
...
function florius_unarmed_3(){
	...
	if ($('#c3_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f83a.highres.jpeg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c3_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c3_1" id="menu_c3_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f83a.highres.jpeg" onclick = "swap_picture(\'c3_1,menu_c3_1,text_c3_1, florius_text_c3_1);">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_07r-1.jpg" onclick = "swap_picture(\'c3_1\', menu_c3_1,text_c3_1, getty_c3_1)">Selected Version: Getty</option> \
		...
		$(\'#note_c3_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c3_1\",$(\'#note_c3_1\').val());\
			$(\'#note_c3_1\').val(localStorage.getItem(\"florius_unarmed_c3_1\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f83b.highres.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c3_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c3_2" id="menu_c3_2" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f83b.highres.jpg" onclick = "swap_picture(\'c3_2,menu_c3_2,text_c3_2, florius_text_c3_2);">Selected Version: Florius</option> \
		...
		$(\'#note_c3_2\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c3_2\",$(\'#note_c3_2\').val());\
			$(\'#note_c3_2\').val(localStorage.getItem(\"florius_unarmed_c3_2\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f84a.highres.jpeg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c3_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c3_3" id="menu_c3_3" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f84a.highres.jpeg" onclick = "swap_picture(\'c3_3,menu_c3_3,text_c3_3, florius_text_c3_3);">Selected Version: Florius</option> \
		...
		$(\'#note_c3_3\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c3_3\",$(\'#note_c3_3\').val());\
			$(\'#note_c3_3\').val(localStorage.getItem(\"florius_unarmed_c3_3\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f84b.highres.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c3_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c3_4" id="menu_c3_4" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f84b.highres.jpg" onclick = "swap_picture(\'c3_4,menu_c3_4,text_c3_4, florius_text_c3_4);">Selected Version: Florius</option> \
		...
		$(\'#note_c3_4\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c3_4\",$(\'#note_c3_4\').val());\
			$(\'#note_c3_4\').val(localStorage.getItem(\"florius_unarmed_c3_4\"));\
		});\
		</script><br><br>';
...
function florius_unarmed_4(){
	...
	if ($('#c4_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f85a.highres.jpeg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_1" id="menu_c4_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f85a.highres.jpeg" onclick = "swap_picture(\'c4_1,menu_c4_1,text_c4_1, florius_text_c4_1);">Selected Version: Florius</option> \
		...
		$(\'#note_c4_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c4_1\",$(\'#note_c4_1\').val());\
			$(\'#note_c4_1\').val(localStorage.getItem(\"florius_unarmed_c4_1\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f85b.highres.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_2" id="menu_c4_2" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f85b.highres.jpg" onclick = "swap_picture(\'c4_2,menu_c4_2,text_c4_2, florius_text_c4_2);">Selected Version: Florius</option> \
		...
		$(\'#note_c4_2\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c4_2\",$(\'#note_c4_2\').val());\
			$(\'#note_c4_2\').val(localStorage.getItem(\"florius_unarmed_c4_2\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f86a.highres.jpeg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_3" id="menu_c4_3" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f86a.highres.jpeg" onclick = "swap_picture(\'c4_3,menu_c4_3,text_c4_3, florius_text_c4_3);">Selected Version: Florius</option> \
		...
		$(\'#note_c4_3\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c4_3\",$(\'#note_c4_3\').val());\
			$(\'#note_c4_3\').val(localStorage.getItem(\"florius_unarmed_c4_3\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f86b.highres.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c4_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c4_4" id="menu_c4_4" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f86b.highres.jpg" onclick = "swap_picture(\'c4_4,menu_c4_4,text_c4_4, florius_text_c4_4);">Selected Version: Florius</option> \
		...
		$(\'#note_c4_4\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c4_4\",$(\'#note_c4_4\').val());\
			$(\'#note_c4_4\').val(localStorage.getItem(\"florius_unarmed_c4_4\"));\
		});\
		</script><br><br>';
...
function florius_unarmed_5(){
	...
	if ($('#c5_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f87a.highres.jpeg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_1" id="menu_c5_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f87a.highres.jpeg" onclick = "swap_picture(\'c5_1,menu_c5_1,text_c5_1, florius_text_c5_1);">Selected Version: Florius</option> \
		...
		$(\'#note_c5_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c5_1\",$(\'#note_c5_1\').val());\
			$(\'#note_c5_1\').val(localStorage.getItem(\"florius_unarmed_c5_1\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f87b.highres.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_2" id="menu_c5_2" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f87b.highres.jpg" onclick = "swap_picture(\'c5_2,menu_c5_2,text_c5_2, florius_text_c5_2);">Selected Version: Florius</option> \
		...
		$(\'#note_c5_2\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c5_2\",$(\'#note_c5_2\').val());\
			$(\'#note_c5_2\').val(localStorage.getItem(\"florius_unarmed_c5_2\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f88a.highres.jpeg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_3" id="menu_c5_3" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f88a.highres.jpeg" onclick = "swap_picture(\'c5_3,menu_c5_3,text_c5_3, florius_text_c5_3);">Selected Version: Florius</option> \
		...
		$(\'#note_c5_3\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c5_3\",$(\'#note_c5_3\').val());\
			$(\'#note_c5_3\').val(localStorage.getItem(\"florius_unarmed_c5_3\"));\
		});\
		</script><br><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f88b.highres.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c5_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c5_4" id="menu_c5_4" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f88b.highres.jpg" onclick = "swap_picture(\'c5_4,menu_c5_4,text_c5_4, florius_text_c5_4);">Selected Version: Florius</option> \
		...
		$(\'#note_c5_4\').on(\'change\', function(){\
			localStorage.setItem(\"florius_unarmed_c5_4\",$(\'#note_c5_4\').val());\
			$(\'#note_c5_4\').val(localStorage.getItem(\"florius_unarmed_c5_4\"));\
		});\
		</script><br><br>';
