...
function florius_oh_sword_1(){
	...
	if ($('#c1_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f23.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_1" id="menu_c1_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f23.highresb.jpg" onclick = "swap_picture(\'c1_1\', menu_c1_1,text_c1_1, florius_text_c1_1)">Selected Version: Florius</option> \
				...
				<option   value="img/PD-images/1024px-Pisani-Dossi_MS_13a3.jpg" onclick = "swap_picture(\'c1_1\', menu_c1_1,text_c1_1, pd_text_c1_1)">Selected Version: Pisani-Dossi</option> \
		...
		$(\'#note_c1_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_oh_c1_1\",$(\'#note_c1_1\').val());\
			$(\'#note_c1_1\').val(localStorage.getItem(\"florius_oh_c1_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f24.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_2" id="menu_c1_2" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f24.highresa.jpg" onclick = "swap_picture(\'c1_2\', menu_c1_2,text_c1_2, florius_text_c1_2)">Selected Version: Florius</option> \
				<option   value="img/PD-images/1024px-Pisani-Dossi_MS_13a4.jpg" onclick = "swap_picture(\'c1_2\', menu_c1_2,text_c1_2, pd_text_c1_2)">Selected Version: Pisani-Dossi</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c1_2\').on(\'change\', function(){\
			localStorage.setItem(\"florius_oh_c1_2\",$(\'#note_c1_2\').val());\
			$(\'#note_c1_2\').val(localStorage.getItem(\"florius_oh_c1_2\"));\
		});\
		</script><br>';
	...
	//image file 2nd scholar
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f24.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_3" id="menu_c1_3" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f24.highresb.jpg" onclick = "swap_picture(\'c1_3\', menu_c1_3,text_c1_3, florius_text_c1_3)">Selected Version: Florius</option> \
				...
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_13b1.jpg" onclick = "swap_picture(\'c1_3\', menu_c1_3,text_c1_3, pd_text_c1_3)">Selected Version: Pisani-Dossi</option> \
		...
		$(\'#note_c1_3\').on(\'change\', function(){\
			localStorage.setItem(\"florius_oh_c1_4\",$(\'#note_c1_3\').val());\
			$(\'#note_c1_3\').val(localStorage.getItem(\"florius_oh_c1_3\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f25.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_4"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_4" id="menu_c1_4" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f25.highresa.jpg" onclick = "swap_picture(\'c1_4\', menu_c1_4,text_c1_4, florius_text_c1_4)">Selected Version: Florius</option> \
				<option  value="img/PD-images/1024px-Pisani-Dossi_MS_13b2.jpg" onclick = "swap_picture(\'c1_4\', menu_c1_4,text_c1_4, pd_text_c1_4)">Selected Version: Pisani-Dossi</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c1_4\').on(\'change\', function(){\
			localStorage.setItem(\"florius_oh_c1_4\",$(\'#note_c1_4\').val());\
			$(\'#note_c1_4\').val(localStorage.getItem(\"florius_oh_c1_4\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f25.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_5"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_5" id="menu_c1_5" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f25.highresb.jpg" onclick = "swap_picture(\'c1_5\', menu_c1_5,text_c1_5, florius_text_c1_5)">Selected Version: Florius</option> \
		...
		$(\'#note_c1_5\').on(\'change\', function(){\
			localStorage.setItem(\"florius_oh_c1_5\",$(\'#note_c1_5\').val());\
			$(\'#note_c1_5\').val(localStorage.getItem(\"florius_oh_c1_5\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f26.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c1_6"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c1_6" id="menu_c1_6" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f26.highresa.jpg" onclick = "swap_picture(\'c1_6\', menu_c1_6,text_c1_6, florius_text_c1_6)">Selected Version: Florius</option> \
				...
				<option   value="img/PD-images/1024px-Pisani-Dossi_MS_13b4.jpg" onclick = "swap_picture(\'c1_6\', menu_c1_6,text_c1_6, pd_text_c1_6)">Selected Version: Pisani-Dossi</option> \
		...
		$(\'#note_c1_6\').on(\'change\', function(){\
			localStorage.setItem(\"florius_oh_c1_6\",$(\'#note_c1_6\').val());\
			$(\'#note_c1_6\').val(localStorage.getItem(\"florius_oh_c1_6\"));\
		});\
		</script><br>';
...
//1st master scholars 6-8
function florius_oh_sword_2(){
	...
	if ($('#c2_1').length > 0){
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f26.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_1"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_1" id="menu_c2_1" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f26.highresb.jpg" onclick = "swap_picture(\'c2_1\', menu_c2_1,text_c2_1, florius_text_c2_1)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_21r1.jpg" onclick = "swap_picture(\'c2_1\', menu_c2_1,text_c2_1, getty_c2_1)">Selected Version: Getty</option> \
		...
		$(\'#note_c2_1\').on(\'change\', function(){\
			localStorage.setItem(\"florius_oh_c2_1\",$(\'#note_c2_1\').val());\
			$(\'#note_c2_1\').val(localStorage.getItem(\"florius_oh_c2_1\"));\
		});\
		</script><br>';
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f27.highresa.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_2"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_2" id="menu_c2_2" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f27.highresa.jpg" onclick = "swap_picture(\'c2_2\', menu_c2_2,text_c2_2, florius_text_c2_2)">Selected Version: Florius</option> \
				<option  value="img/getty-images/1024px-MS_Ludwig_XV_13_21r3.jpg" onclick = "swap_picture(\'c2_2\', menu_c2_2,text_c2_2, getty_c2_2)">Selected Version: Getty</option> \
				<option   value="img/PD-images/1024px-Pisani-Dossi_MS_14b1.jpg" onclick = "swap_picture(\'c2_2\', menu_c2_2,text_c2_2, pd_text_c2_2)">Selected Version: Pisani-Dossi</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c2_2\').on(\'change\', function(){\
			localStorage.setItem(\"florius_oh_c2_2\",$(\'#note_c2_2\').val());\
			$(\'#note_c2_2\').val(localStorage.getItem(\"florius_oh_c2_2\"));\
		});\
		</script><br>';
	...
	//image file 8th scholar
		...
		<br><div style="width:80%; text-align:center;"> \
			<img src = "img/florius-images/f27.highresb.jpg" style="max-height: 100%; max-width: 100%; padding-left: 15%;" id = "c2_3"> \
		</div>';
		...
		<div class="ui-field-contain" > \
			...
			<select name = "menu_c2_3" id="menu_c2_3" data-mini="true" stlye = "padding-left: 15%;" onchange = "this.options[this.selectedIndex].onclick()" onchange = "this.options[this.selectedIndex].onclick()"> \
				<option selected="selected" value="img/florius-images/f27.highresb.jpg" onclick = "swap_picture(\'c2_3\', menu_c2_3,text_c2_3, florius_text_c2_3)">Selected Version: Florius</option> \
				<option value="img/getty-images/1024px-MS_Ludwig_XV_13_21r2.jpg" onclick = "swap_picture(\'c2_3\', menu_c2_3,text_c2_3, getty_c2_3)">Selected Version: Getty</option> \
				<option   value="img/PD-images/1024px-Pisani-Dossi_MS_14a4.jpg" onclick = "swap_picture(\'c2_3\', menu_c2_3,text_c2_3, pd_text_c2_3)">Selected Version: Pisani-Dossi</option> \
			</select> \
		</div> \
		</form>\
		\
		...
		$(\'#note_c2_3\').on(\'change\', function(){\
			localStorage.setItem(\"florius_oh_c2_3\",$(\'#note_c2_3\').val());\
			$(\'#note_c2_3\').val(localStorage.getItem(\"florius_oh_c2_3\"));\
		});\
		</script><br>';
